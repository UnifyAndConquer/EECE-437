...
2 - automate the definition of new expressions using a macro like in assignment 2. just change the truth table with a macro.

3 - fix the printing function too.
